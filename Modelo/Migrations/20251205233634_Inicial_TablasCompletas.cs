...
{
    /// <inheritdoc />
    public partial class Inicial_TablasCompletas : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ingresos", x => x.MovimientoId);
                    table.ForeignKey(
                        name: "FK_Ingresos_Personas_ProveedorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ventas", x => x.MovimientoId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "DetallesIngreso",
                columns: table => new
                {
                    DetalleIngresoId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DetallesIngreso", x => x.DetalleIngresoId);
                    table.ForeignKey(
                        name: "FK_DetallesIngreso_Ingresos_IngresoId",
                        column: x => x.IngresoId,
                        principalTable: "Ingresos",
                        principalColumn: "MovimientoId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DetallesIngreso_Productos_ProductoId",
                        column: x => x.ProductoId,
                        principalTable: "Productos",
                        principalColumn: "ProductoId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetallesIngreso_IngresoId",
                table: "DetallesIngreso",
                column: "IngresoId");

            migrationBuilder.CreateIndex(
                name: "IX_DetallesIngreso_ProductoId",
                table: "DetallesIngreso",
                column: "ProductoId");
